    ...
    <header class="header">
      <nav class="nav">
        ...
        <div class="nav-actions">
          <!-- 群 链接 -->
        <a id="fixed-qq" target="_blank" href="https://qm.qq.com/cgi-bin/qm/qr?k=OQkNBrAlliiSJPGiSS2uXEBSYmJ0uxiP&jump_from=webapi&authKey=TZjzoU27vHehNX+qBLBzrP1qlPjFGd1u7+ok1qEN0GR8x3tpBUBIkSZrueOw7X4Q">
            <img src="https://easy321.top/assets/images/group.png" alt="Easy | TV接口资源导航网" title="QQ群：807916734">
        </a>
          <!-- 设置按钮 -->
